"""Durable local state and content-addressed artifacts for the RICH v2 control plane.

The store deliberately persists JSON documents instead of importing the v2 model layer.
