"""Verified public-build execution for approved RICH v2 runs.
...
from .models import ArchitectureSpecV2, EvidenceKind, ProjectSpecV2
...
class RunEngine:
    ...
    def _load_and_validate(
        ...
        *,
        ...
        architecture = ArchitectureSpecV2.from_dict(
...
def _validate_protected_scaffold(
    ...
    *,
    ...
    for candidate in sorted(workspace.rglob("*")):
        ...
        if candidate.is_dir() or _is_runtime_output(relative):
            continue
