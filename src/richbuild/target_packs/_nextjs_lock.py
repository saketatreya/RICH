...
Generated by ``tools/refresh_nextjs_lock.py`` -- never by hand -- from pnpm
10.34.5 with lifecycle scripts disabled and strict peer dependencies, over the
largest scaffold the pack renders: every optional workspace importer and every
edge between them. The pack cuts each smaller scaffold's lock out of this one
(``nextjs._pnpm_lockfile``), and ``tests/test_nextjs_pack.py`` holds every cut
to the manifests rendered beside it. The placeholder package scope is replaced
locally by the deterministic target pack renderer; no registry access occurs
...
importers:
  ...
  packages/db:
    dependencies:
      ...
      drizzle-orm:
        specifier: 0.45.2
        version: 0.45.2(@electric-sql/pglite@0.5.8)(postgres@3.4.9)
      postgres:
        specifier: 3.4.9
        version: 3.4.9
    devDependencies:
...
snapshots:
  ...
  drizzle-orm@0.45.2(@electric-sql/pglite@0.5.8)(postgres@3.4.9):
    optionalDependencies:
      '@electric-sql/pglite': 0.5.8
      postgres: 3.4.9
