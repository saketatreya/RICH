...
def interviewer_prompt(
    *,
    ...
    system_prompt = (
        ...
        "generated for the scenario's first requirement, which is where its "
        "forms, buttons and results live -- a scenario that fills, clicks or "
        "presses keys starts there. 'navigate' takes a local path such as "
        "'/', the home page, which only lists the capabilities. 'fill', "
        "'press', 'assert_text' and "
