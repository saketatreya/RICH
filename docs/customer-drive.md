...
| 3 | Readable spec with scenarios as editable sentences; approves | Requirements and scenarios render as sentences with dropdowns; the canvas and the Playwright titles say the same words | drive M2; `web/src/components/intent/steps.test.ts` against the shared fixture | — |
